        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="box box-primary">
                 ...
                 <!-- SE ENVIAN LOS DATOS DEL FORM AL METODO STORE PARA GUARDARL LOS DATOS INGRESADOS-->
                        ...
                        <!-- CAMPO NOMBRES COMO INPUT TEXT CON MENSAJES DE ERRORES DE VALIDACION-->
                          ...
                          <!-- CAMPO RUT COMO INPUT TEXT CON MENSAJES DE ERRORES DE VALIDACION-->
                              ...
                              <div class="form-group {{ $errors->has('rut') ? 'has-error' :'' }}">
                                ...
                                {!!Form::text('rut',null,['class' => 'form-control input', 'style' => 'width:300px;', 'oninput' => 'checkRut(this)', 'id' => 'rut' , 'placeholder' => 'Ej: 12345678-k'])!!}
                                @if ($errors->has('rut'))
                                    <span class="help-block">
